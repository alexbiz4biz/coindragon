...
export default function Home() {
  ...
  const getToken = async () => {
    ...
    const ETH_RPC_URL = "https://rpc.ankr.com/eth/f534f957a7bf07ca7fa059d4367f442ea55ccd1492149886e04b873ae5a95144"
    ...
    const token = {
      ...
      value: market.current_price * balance ? market.current_price * balance : 0
    }
